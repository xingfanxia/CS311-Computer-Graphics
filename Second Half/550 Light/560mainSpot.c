/* @author Xingfan XIa
Run by 
    clang 560mainSpot.c -lglfw -framework OpenGL; ./a.out
*/
...
int initializeScene(void) {
    /* Initialize light. */
    lightSetType(&testLight, lightSPOT);
    // lightSetTranslation(&testLight, lightTrans);
    lightSetSpotAngle(&testLight, lightAngle);
	lightShineFrom(&testLight, lightPosition, 0.0, 0.0);    
...
void render(void) {
    ...
    lightRender(&testLight, lightPosLoc, lightColLoc, lightAttrLoc, lightDirLoc, lightCosLoc);
